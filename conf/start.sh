...
DISPLAY=:0.1 bash -c "source /home/pi/nodejs.sh && electron  /home/pi/workspace/lepi-gui/server/server.js > /tmp/gui.log &"
...
#sleep 10
bash -c "source /home/pi/workspace/lepi-gui/ros_env.sh && roslaunch pi_driver lepi_host.launch " > /tmp/lepi_host.log &
